...
class DNLATR(BaseDetector):
    ...
    def pre_decoder(self, memory: Tensor) -> Tuple[Dict, Dict]:
        ...
        query_pos = query_pos.unsqueeze(0).repeat(batch_size, 1, 1) #repeat query for batch input
        if self.num_patterns == 0:
    ...
    def forward_transformer(self,
        ...
        """
        #print(f"(img_feats{img_feats[0].shape}:(B,256,h/32,w/32),
        #      batch_feature:{batch_feature[0].shape}(B,512,h/8,w/8))")
